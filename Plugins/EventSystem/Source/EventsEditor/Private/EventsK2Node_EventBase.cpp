...
namespace
{
	...
	static FName SenderPinName(TEXT("Sender"));
	static FName ListenerPinName(TEXT("Listener"));
}
...
UEdGraphPin* UEventsK2Node_EventBase::GetListenerPin() const
{
	return FindPin(ListenerPinName);
}
